...
Justificación de la elección: Desacopla el sistema de inventario de otros módulos (ventas, alertas).
Ejemplo en el código:
class Observador:
...
Problema que resuelve: Crear distintos tipos de productos sin acoplar el código.
Justificación de la elección: Permite agregar nuevos productos fácilmente.
Ejemplo en el código:
class Producto:
