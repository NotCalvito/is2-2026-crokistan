...
__¿Qué tareas principales realizan y en qué contexto (dispositivo, entorno, restricciones)?__  
  ...
  La restricción principal sería el dispositivo del sistema, ya que necesitar una computadora es menos práctico y barato que poder manejarlo en algo más cómodo como el celular, lo cual lo haría más transportable y cómodo.
